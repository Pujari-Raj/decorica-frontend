...
function Profile() {
  ...
  const splitAddress = () =>{
    const [line1, landmark, city, country, pincode]  =  userData && userData.address.split(',').map(part => part.trim());
  ...
  return (
    ...
    <div className="personal-info flex px-10 bg-white text-lg mx-10 justify-center rounded-2xl shadow-2xl py-10 mt-10">
      <div>
      <h1 className='text-4xl font-bold p-10'>Personal Information</h1>
        <form action="" className='grid px-10'>
          ...
          <div className="grid mt-5">
                        <label htmlFor="text" className='mb-2  font-semibold'>Your Address</label>
