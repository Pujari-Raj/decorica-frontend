...
const HeroSection = () => {
  return (
    <div
      className="flex min-h-screen bg-no-repeat bg-center relative"
      style={{
    ...
    >
      <div className="text-white w-3/6 absolute left-[50px] top-[90px] content-center pl-8">
        ...
        Transform your space with our innovative designs that blend aesthetics with functionality. We create interiors that reflect your personality and elevate your lifestyle.
        </p>
        ...
        <div className="flex gap-10 divide-x-2 divide-gray-950">
          <div className="">
